...
<section class="dashboard">
    <div class="container">
        ...
        <div class="topo">
            <div class="btn">
                <a href="<?=URL_BASE?>admin/blogs-create" class="btn">
                    Cadastrar novo
                </a>
            </div>
            ...
            <table>
                ...
                <tbody>
                    <tr>
                        <td class="id">1</td>
                        <td class="acao">
                            <a href="<?=URL_BASE?>admin/blogs-edit/1"><i class="far fa-edit"></i></a>
                            <a href="#"><i class="fas fa-trash"></i></a>
                        </td>
                        <td class="titulo-item">Aqui vem o título do blog</td>
